...
\lhead{LC\&B - 04.2 Plasticity - Conor}
\rhead{\thepage}
\cfoot{}
\begin{document}
...
Long term plasticity, the changes in synaptic strength that appear to
result from activity in the pre- and post-synaptic neuron, is thought
to be the main mechanism that supports learning and development in the
brain.
